 import assert from 'https://cdn.jsdelivr.net/npm/assert@2.1.0/+esm';
...
export function serialize (nrrdOrg) {
    ...
    Object.getOwnPropertyNames(nrrdOrg).forEach((key) => {
      nrrd[key] = nrrdOrg[key];
    });

    console.log("nrrd before serialization:", nrrd);
